...
public class Main {
    ...
    private static boolean findProject(String title, String name) {
        File file = new File("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java\\" +
                "AP_Project_BackEnd\\Data Base Files\\Courses\\" + name + "\\Project\\" + title + ".txt");
        return file.isFile();
    }

    private static Assignment getProjectFromDataBase(String title, String name) {
        try {
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java" +
                "\\AP_Project_BackEnd\\Data Base Files\\Courses\\" + name + "\\Project\\" + title + ".txt"));
    ...
    private static boolean addProject(String title, Course course, int deadLine) {
        try {
            File dir = new File("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java" +
                    "\\AP_Project_BackEnd\\Data Base Files\\Courses\\" + course.getName() + "\\Project");
            ...
            FileOutputStream fos = new FileOutputStream("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java" +
                    "\\AP_Project_BackEnd\\Data Base Files\\Courses\\" + course.getName() + "\\Project\\" + title + ".txt");
    ...
    private static void removeCourse(String name) {
        ...
        file.delete();
        deleteDirectory(new File("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java\\" +
                "AP_Project_BackEnd\\Data Base Files\\Courses\\" + name));
    }
    ...
    private static void addCourse(String name, int units, String examDate) {
        try {
            File dir = new File("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java" +
                    "\\AP_Project_BackEnd\\Data Base Files\\Courses\\" + name);
            dir.mkdirs();
            File dir1 = new File("C:\\Users\\Sumsung\\OneDrive\\Documents\\Java" +
                    "\\AP_Project_BackEnd\\Data Base Files\\Courses\\" + name + "\\" + "Project");
            dir1.mkdirs();
                        ...
                        switch (order) {
                            ...
                            case 5: {
                                ...
                                if (addProject(title, course, deadLine)) {
                                    ...
                                    Assignment assignment = getProjectFromDataBase(title, course.getName());

                                    switch (teacher.addProjectToCourse(assignment, course)) {
                                        case 1:
                                            removeAssignment(assignment);
                                            System.out.println("You don't have access to this course");
                                            break;
                                    ...
                                    System.out.println("Project is already defined");
                                }
                                break;
                            }
                            case 6: {
                                ...
                                while (!findProject(title, name)) {
                                    System.out.println("There is no such project! TRy again");
                                    title = input.next();
                                }
                                ...
                                switch (teacher.removeProjectFromCourse(assignment, course)) {
                                    case 1:
                                        System.out.println("You don't have access to this course");
                                        break;
                                    case 2:
